...
namespace Apotek.Migrations
{
    ...
    [Migration("20250422075947_AddKolomNamaDisplaySnapshotInMutasiBarangDisplay")]
    partial class AddKolomNamaDisplaySnapshotInMutasiBarangDisplay
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Apotek.Models.StokMutasiBarangDisplay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("BarangDisplayId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("JumlahKonversi")
                        .HasColumnType("integer");

                    b.Property<int>("JumlahStokDisplay")
                        .HasColumnType("integer");

                    b.Property<string>("NamaDisplaySnapshot")
                        .HasColumnType("text");

                    b.Property<int>("StokGudangSaatItu")
                        .HasColumnType("integer");

                    b.Property<string>("TipeMutasi")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<DateTime>("WaktuMutasi")
                        .HasColumnType("timestamp with time zone");

                    b.HasKey("Id");

                    b.HasIndex("BarangDisplayId");

                    b.ToTable("StokMutasiBarangDisplays");
                });
            ...
            modelBuilder.Entity("Apotek.Models.StokMutasiBarangDisplay", b =>
                {
                    b.HasOne("Apotek.Models.BarangDisplay", "BarangDisplay")
                        .WithMany()
                        .HasForeignKey("BarangDisplayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BarangDisplay");
                });
